...
class MetricsLogger:
    ...
    def write_validation_summary(self, update_idx: int, metrics: dict[str, Any]) -> None:
        ...
        columns = [
            ...
            "validation/reset_root_lin_vel_err",
            "validation/reset_root_ang_vel_err",
            "validation/reset_body_pos_err",
            "validation/reset_body_ori_deg",
            "validation/tracking/joint_pos_mae/mean",
            "validation/tracking/joint_pos_mae/p95",
            "validation/tracking/joint_vel_mae/mean",
            "validation/tracking/joint_vel_mae/p95",
            "validation/tracking/root_lin_vel_mae/mean",
            "validation/tracking/root_lin_vel_mae/p95",
            "validation/tracking/root_ang_vel_mae/mean",
            "validation/tracking/root_ang_vel_mae/p95",
            "validation/dynamics/action_delta/mean",
            "validation/dynamics/action_delta/p95",
            "validation/dynamics/action_delta/p99",
            "validation/dynamics/action_d2/mean",
            "validation/dynamics/action_d2/p95",
            "validation/dynamics/action_d2/p99",
            "validation/dynamics/joint_vel_jump/mean",
            "validation/dynamics/joint_vel_jump/p95",
            "validation/dynamics/root_lin_vel_jump/mean",
            "validation/dynamics/root_lin_vel_jump/p95",
