...
class MetricsLogger:
    ...
    def write_validation_summary(self, update_idx: int, metrics: dict[str, Any]) -> None:
        ...
        columns = [
            ...
            "validation/chunk_action_delta_boundary_component_rms",
            "validation/chunk_action_delta_internal_component_rms",
            "validation/chunk_action_delta_boundary_internal_component_rms_ratio",
            "validation/chunk_action_d2_boundary_component_rms",
            "validation/chunk_action_d2_internal_component_rms",
            "validation/chunk_action_d2_boundary_internal_component_rms_ratio",
            "validation/chunk_action_delta_boundary_component_count",
            "validation/chunk_action_delta_internal_component_count",
