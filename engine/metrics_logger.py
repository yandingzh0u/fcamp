...
class MetricsLogger:
    ...
    def write_validation_summary(self, update_idx: int, metrics: dict[str, Any]) -> None:
        ...
        columns = [
            ...
            "validation/physical_failure_frac",
            "validation/illegal_contact_frac",
            "validation/numerical_failure_frac",
            "validation/tracking_failure_counterfactual_frac",
            "validation/anchor_pos_bad_counterfactual_frac",
            "validation/anchor_ori_bad_counterfactual_frac",
            "validation/ee_body_bad_counterfactual_frac",
            "validation/reference_motion_end_reached_frac",
            "validation/terminal_contact_force_max_mean",
            "validation/terminal_illegal_contact_body_count_mean",
            "validation/physical_failure_contact_force_max_mean",
            "validation/physical_failure_illegal_contact_body_count_mean",
