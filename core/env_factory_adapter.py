...
def build_env(cfg):
    ...
    return G1MimicEnv(
        MimicEnvConfig(
            ...
            adaptive_lambda=e.adaptive_lambda,
            adaptive_alpha=e.adaptive_alpha,
            adaptive_causal_max_ratio=e.adaptive_causal_max_ratio,
            adaptive_causal_horizon=e.adaptive_causal_horizon,
            adaptive_causal_decay=e.adaptive_causal_decay,
            adaptive_causal_arm_lo=e.adaptive_causal_arm_lo,
            adaptive_causal_arm_hi=e.adaptive_causal_arm_hi,
