"""Standard MimicKit-style AMP discriminator and objective."""
...
@dataclass
class AMPDiscriminatorLossOutput:
    loss: torch.Tensor
...
def compute_amp_discriminator_loss(
    ...
    *,
    ...
    return AMPDiscriminatorLossOutput(loss=total, metrics=metrics)
