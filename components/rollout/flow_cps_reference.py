"""Reference Flow-CPS collect/update/log used only by unit tests.

Production FCAMP overrides these paths on FlowCPSBase and never calls them.
"""
...
class FlowCPSReferenceAlgorithm(FlowCPSBase):
