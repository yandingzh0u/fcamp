...
class FlowCPSBase(Algorithm):
    ...
    def update(self, rollout: dict, collect_time: float) -> dict:
        ...
        for epoch in range(int(self.cfg.policy_epochs)):
            ...
            for start in range(0, batch_size, mini_batch_size):
                ...
                for micro_start in range(0, mb_size, micro_batch_size):
                    ...
                    # steps. This keeps the clipped policy ratio in the same units as the
        ...
        update_metrics = {
            ...
            "flow_cps/cps_train_steps": float(train_step_indices.numel()),
            ...
            "flow_cps/action_transform": 2.0,  # residual_absolute
    ...
    def log(self, update_idx: int, max_updates: int, metrics: dict) -> None:
        ...
        print(
            ...
            f"cps_steps={metrics.get('flow_cps/cps_train_steps', float('nan')):.0f} "
